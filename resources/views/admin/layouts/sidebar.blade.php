 ...
 <aside class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
      <div>
        <img src="/assets/images/sidelogo.webp" class="logo-icon" alt="logo icon">
      </div>
      <div class="logo-text">
        <img src="/assets/images/namelogo.webp" class="logo-name" alt="logo name">
        {{-- <h4>KOSHER MAN</h4> --}}
      </div>
    </div>
    <!--navigation-->
    <ul class="metismenu" id="menu">
      ...
      <li>
        <a href="{{ route('admin.price.index') }}">
          ...
          <div class="menu-title">Price Plan</div>
        </a>
      </li>
      ...
      <li>
        <a class="has-arrow" href="javascript:;">
          ...
          <ul>
            <li><a href="{{ route('admin.gallery.portrait.list') }}">
                <ion-icon name="ellipse-outline"></ion-icon>Portrait
              </a>
            </li>
            <li><a href="{{ route('admin.gallery.photo.list') }}">
                <ion-icon name="ellipse-outline"></ion-icon>Photo
              </a>
            </li> 
          </ul> 
      </li>
      <li>
        <a href="{{ route('admin.info.list') }}">
          ...
          <div class="menu-title">Company Info</div>
        </a>
      </li>
      <li>
      ...
      <li>
        <a class="has-arrow" href="javascript:;">
          ...
          <div class="menu-title">Metadata</div>
        </a>
          <ul>
