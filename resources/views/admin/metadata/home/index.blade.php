        ...
        <div class="row">
            <div class="col-lg-11 mx-auto">
                ...
                <div class="card radius-10">
                    <div class="card-body">
                        <form class="row g-3" action="{{ route('admin.metadata.Create') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="input35" name="title" placeholder="TITLE" value="{{ old('title') }}">
                                        @error('title')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="keywords" rows="3" cols="100" placeholder="KEYWORDS" >{{ old('keywords') }}</textarea>
                                        @error('keywords')  
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="description" rows="3" cols="100" placeholder="DESCRIPTION">{{ old('description') }}</textarea>
                                        @error('description')  
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                        ...
                        <tbody>
                            ...
                            @foreach( $data as $key => $data )
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.metadata.Edit', $data->id) }}" class="btn btn-success">Edit</a>
                                    </td>
                                    <td>
                                        <a href="{{ route('admin.metadata.delete', $data->id) }}" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                            <?php $id += 1; ?>
                            @endforeach
